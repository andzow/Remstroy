    ...
    <div class="footer__container">
        <div class="footer__info">
            ...
            <div class="footer__item footer__item_center">
                ...
                <p class="footer__text footer__app" @click="scrollToAnchor('company')">Компания</p>
                <p class="footer__text footer__app" @click="scrollToAnchor('services')">Услуги</p>
                <p class="footer__text footer__app" @click="scrollToAnchor('blog')">Блог</p>
            </div>
            <div class="footer__item">
